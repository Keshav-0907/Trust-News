...
const Newsind = () => {
    ...
    const newsfetch = async () => {
        await axios.get(
            "https://newsapi.org/v2/everything?q=india&from=2023-02-07&to=2023-02-07&sortBy=popularity&apiKey=b9e3a15f53aa4197b715731f652966b4"
  ...
  return (
    <div className='main'>
        <h2 className='head'> General News </h2>
